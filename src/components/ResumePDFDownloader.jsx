...
export const createResumePDF = (parsedData) => {
...
export const generatePDFBlob = (parsedData) => {
  const pdf = createResumePDF(parsedData);
  return pdf.output("blob");
};

// Function to download PDF
export const downloadResumePDF = (parsedData) => {
  const pdf = createResumePDF(parsedData);
